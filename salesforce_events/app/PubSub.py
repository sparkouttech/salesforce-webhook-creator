...
import salesforce_events.app.pubsub_api_pb2 as pb2
import salesforce_events.app.pubsub_api_pb2_grpc as pb2_grpc
...
class PubSub(object):
    ...
    def __init__(self, argument_dict):
        ...
        self.metadata = None
        grpc_host = get_argument('grpc_host', argument_dict)
        grpc_port = get_argument('grpc_port', argument_dict)
